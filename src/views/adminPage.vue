    ...
    traduccionesCategorias() {
      return {
        es: {
          ...
          category6: "Hoja de Vida" // Nueva categoría en español
        },
        en: {
          ...
          category6: "Resume" // Nueva categoría en inglés
        },
      };
    },
  },
    ...
    const fetchUserAdvances = async (userId, userName) => {
      try {
        ...
        if (userSnap.exists() && userSnap.data().resumeURL) {
          resumeData = {
            name: "Hoja de Vida/Resume", // Nombre base que luego se traducirá
            url: userSnap.data().resumeURL,
            timestamp: userSnap.data().resumeUploadedAt || new Date() // Usar fecha de subida o actual
          };
        }
        ...
        if (userDocSnap.exists()) {
          ...
          advances.forEach((advance) => {
            ...
            switch (advance.name) {
              ...
              case "Documentos Universidad":
                ...
                break;
              case "Hoja de Vida": // Nuevo caso para español
          ...
          // Caso donde solo existe el resume
          userAdvances.value = {
            category6: [resumeData]
          };
        } else {
          userAdvances.value = {};
        }
...
.centradoBoton {
  display: flex;
  flex-wrap: wrap;
  /* Evita que los botones se desborden */
